...
def test():	
	X =  WatsonSHCoefficients(4)
	print X
	if ((np.square(X[0]-3.5449) + np.square(X[1]-4.4147) + np.square(X[2]-2.1933) + np.square(X[3]-0.7212) + np.square(X[4]-0.1782) + np.square(X[5]-0.0353) + np.square(X[6]-0.0058)) > 0.0001):
		print "Significant error for kappa=4"
	return 0
