...
def NeumannPerpSignal(d, R, G, delta, smalldel, roots):
	...
	#Set zeros in denominator to 1	
	#for x in np.nditer(sumdenom,op_flags=['readwrite']):
...
A = NeumannPerpSignal(d,R,G,delta,smalldel,roots)
B = A[:,4]
C = B/(1.E36) 
