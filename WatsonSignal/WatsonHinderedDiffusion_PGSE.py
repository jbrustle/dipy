...
from myHinderedDiffCoeff import HDiffCoeff
from HinderedDiffusion_PGSE import SynthMeasHinderedDiffusion_PGSE
import numpy as np


def MeasWatsonHinderedDiffusion_PGSE(x, grad_dirs, G, delta, smalldel, fibredir):
	"""
	...
	dw = HDiffCoeff(dPar, dPerp, kappa)
...
def test_MeasWatsonHinderedDiffusion_PGSE():
    ...
    sample = MeasWatsonHinderedDiffusion_PGSE(x, grad_dirs, G, delta, smalldel, fibredir)

    error = abs(abs(sample[1])- 0.996674384320636) + abs(abs(sample[2])-0.995759335223291) + abs(abs(sample[3])-0.996087234806843) 
    error = error + abs(abs(sample[4])-0.996420333307792) + abs(abs(sample[5])-0.994729395910691) + abs(abs(sample[6])-0.996629701329370) 
